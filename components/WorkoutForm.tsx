...
const COMMON_CONDITIONS = [
  "Thyroid", "PCOS/PCOD", "Diabetes", "High BP", "Back Pain", "Knee Issues"
];
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white p-4 rounded-lg border-2 border-red-100 shadow-sm">
          <label className="block text-lg font-bold text-red-800 mb-3 flex items-center">
            🏥 Health Issues / Injuries <span className="ml-2 text-xs font-normal text-gray-500 bg-gray-100 px-2 py-1 rounded-full">Optional</span>
          </label>
